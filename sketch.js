...
function fruits(){
  ...
  //HABIAS DESCOMENTADO LA OPCION: fruit.velocity= (7+(score/4));
  //Y RECUERDA QUE AL COLOCAR LA VELOCIDAD DEBEMOS IDENTIFICAR EL EJE
  //LA OPCION CORRECTA ES fruit.velocityX= (7+(score/4));
